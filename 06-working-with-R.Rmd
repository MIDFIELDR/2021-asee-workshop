...
- [Getting started](https://midfieldr.github.io/midfieldr/articles/art-000-getting-started.html): An introduction to the MIDFIELD practice data tables. 
- [Case study programs](https://midfieldr.github.io/midfieldr/articles/art-110-case-study-programs.html) Construct a data frame of program CIP codes and program names for four engineering programs (Civil, Electrical, Industrial, and Mechanical) 
...
- [Getting started](https://midfieldr.github.io/midfieldr/articles/art-000-getting-started.html): An introduction to the MIDFIELD practice data tables  
- [Case study programs](https://midfieldr.github.io/midfieldr/articles/art-110-case-study-programs.html) Construct a data frame of program CIP codes and program names for four engineering programs (Civil, Electrical, Industrial, and Mechanical) 
- [Case study students](https://midfieldr.github.io/midfieldr/articles/art-120-case-study-students.html) Develop a data frame of the case study students who pass the data sufficiency criterion. 
