...
These data files are used in the exercises. We use RDS format because it preserves the order (if any) of factors. 
...
- Order the rows and panels to match by the stickiness variable. 
- Use the `as.table = FALSE` argument to impose "graph-order" panels. 
- Check your work by comparing your result to the graph below.
