...
\tightlist
\item
  2.1 \protect\hyperlink{install-r-and-rstudio}{Install R and RStudio}
\item
  2.2 \protect\hyperlink{install-packages-we-need}{Install packages we need}
\item
  2.3 \protect\hyperlink{install-midfielddata}{Install midfielddata}
\item
  2.4 \protect\hyperlink{install-midfieldr}{Install midfieldr}
\item
  3.1 \protect\hyperlink{create-a-project-1}{Create a project}\\
\item
  3.2 \protect\hyperlink{add-some-folders-1}{Add some folders}
\end{itemize}
...
\chapter{Set up a project}\label{setup-project}}

To begin any project, we create an RStudio \emph{Project} file and directory. You can recognize an R project file by its \emph{.Rproj} suffix.

\hypertarget{create-a-project-1}{%
\section{Create a project}\label{create-a-project-1}}
...
\hypertarget{add-some-folders-1}{%
\section{Add some folders}\label{add-some-folders-1}}
...
\protect\hyperlink{setup-project}{▲ top of page}
...
\item
  \protect\hyperlink{install-everything}{Install everything}\\
\item
  \protect\hyperlink{setup-project}{Set up a project}\\
\item
