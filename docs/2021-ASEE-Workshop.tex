...
\FunctionTok{str}\NormalTok{(toy\_student)}
\CommentTok{\#\textgreater{} Classes \textquotesingle{}data.table\textquotesingle{} and \textquotesingle{}data.frame\textquotesingle{}:   100 obs. of  6 variables:}
\CommentTok{\#\textgreater{}  $ mcid          : chr  "MID25783939" "MID25784402" "MID25805538" "MID25808099" ...}
\CommentTok{\#\textgreater{}  $ institution   : chr  "Institution M" "Institution M" "Institution M" "Institution M" ...}
\CommentTok{\#\textgreater{}  $ transfer      : chr  "First{-}Time in College" "First{-}Time in College" "First{-}Time in College" "First{-}Time in College" ...}
\CommentTok{\#\textgreater{}  $ hours\_transfer: num  NA NA NA NA NA NA NA NA NA NA ...}
\CommentTok{\#\textgreater{}  $ race          : chr  "White" "White" "White" "White" ...}
\CommentTok{\#\textgreater{}  $ sex           : chr  "Female" "Male" "Female" "Female" ...}
...
Expect to make errors and don't worry when that happens. You won't break anything. Healy \citeyearpar{Healy:2019} offers this advice for three specific things to watch out for:
