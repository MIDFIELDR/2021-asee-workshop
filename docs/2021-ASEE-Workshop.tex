...
\item
  2.2 \protect\hyperlink{install-the-remotes-package}{Install the remotes package}
\item
  2.3 \protect\hyperlink{install-midfielddata}{Install midfielddata}
\item
  2.4 \protect\hyperlink{install-midfieldr}{Install midfieldr}
\item
  3.1 \protect\hyperlink{create-a-project}{Create a project}\\
\item
  3.2 \protect\hyperlink{add-some-folders}{Add some folders}
\end{itemize}
