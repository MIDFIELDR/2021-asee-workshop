...
A data set has been extracted from the midfieldr `student` table with a sample of 3000 student SAT scores. 

```{r}
sat <- fread("https://github.com/MIDFIELDR/2021-asee-workshop/tree/main/data/sat.csv")
```
...
ggplot(dtf, aes(x = ever, y = reorder(race_sex, ever))) +
  geom_point() +
  scale_x_continuous(trans = "log2") +
  labs(x = "Number of students enrolled (log-2 scale)", y = "")
```
