...
# fwrite(DT, "data/student_demographic.csv")
# saveRDS(DT, "data/student_demographic.rds")
```

Download the file using the readRDS

```{r}
student_demogr <- readRDS("data/student_demographic.rds")
student_demogr
```
